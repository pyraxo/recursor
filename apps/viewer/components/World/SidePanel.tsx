...
export function SidePanel({ selectedTeamId }: SidePanelProps) {
  const [activeTab, setActiveTab] = useState<"readme" | "chat" | "livestream">(
    "readme"
  );
            ...
            <div className="border-t-2 border-[var(--panel-border)] pt-4">
              ...
              <ul className="space-y-2 text-[var(--foreground)]/80">
                <li className="flex gap-2">
                  ...
                  <span>
                    Click on any team in the map to view their progress
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-[var(--accent-primary)]">→</span>
            ...
            <div className="border-t-2 border-[var(--panel-border)] pt-4">
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  <span className="text-[var(--planner-color)] font-bold">
                    Planner:
                  </span>
                ...
                <div className="flex gap-2">
                  <span className="text-[var(--builder-color)] font-bold">
                    Builder:
                  </span>
                  <span className="text-[var(--foreground)]/80">
                    Writes the code
                ...
                <div className="flex gap-2">
                  <span className="text-[var(--reviewer-color)] font-bold">
                    Reviewer:
                  </span>
                  <span className="text-[var(--foreground)]/80">
                    Tests & reviews
                ...
                <div className="flex gap-2">
                  <span className="text-[var(--communicator-color)] font-bold">
                    Communicator:
                  </span>
                  <span className="text-[var(--foreground)]/80">
                    Handles chat
      ...
      <PixelPanel title="Team Details">
        ...
        <div className="flex-1 min-h-0">
          ...
          {activeTab === "livestream" && (
            <LivestreamTab stackId={selectedTeamId} />
          )}
        </div>
      </PixelPanel>
    </div>
